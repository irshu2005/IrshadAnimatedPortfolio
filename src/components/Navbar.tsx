...
const Navbar = () => {
  ...
  return (
    <>
      <div className="header" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '2rem' }}>
        <a
          href="mailto:irshu79054@gmail.com"
        ...
        <ul style={{ display: 'flex', gap: '1.5rem', margin: 0, padding: 0, listStyle: 'none', alignItems: 'center' }}>
          <li>
